...
- [x] AC8 — `examples/mvp_test.py` runs probe first and skips unsupporteded steps → FR-019, SC-010
...
- [x] HTTP 500 is recorded but not classified as supported/unsupporteded → FR-004
