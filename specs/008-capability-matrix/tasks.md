...
- [ ] T025 [US1] Add probe transport-error and parse-error propagation per `contracts/probe-api.md` §"Edge cases" #4 and #5: 401 on step 1 raises `AkuvoxAuthenticationError`;
