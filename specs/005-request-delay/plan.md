...
**Target Platform**: Linux / any platform with Python 3.13.2+
...
tests/unit/
├── test_http.py         # Add/extend delay behavior tests
└── test_device.py       # Add/extend request_delay passthrough tests
```
